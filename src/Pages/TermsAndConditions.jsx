...
const TermsAndConditions = () => {
  return (
    <Container>
      ...
      <div className="bg-gray-50 dark:bg-gray-900 min-h-screen py-10 px-6 md:px-20 text-gray-800 dark:text-gray-200">
        <div className="max-w-4xl mx-auto p-8">
          <h1 className="text-3xl font-bold text-center mb-6 text-orange-600 dark:text-orange-400">
            Terms & Conditions
          </h1>

          <p className="mb-6 text-gray-600 text-center dark:text-gray-400">
            Welcome to <strong>PlateShare</strong>! Please read these Terms and
            Conditions carefully before using our platform.
          </p>

          <section className="space-y-6">
            <div>
              <h2 className="text-xl font-semibold mb-2 text-orange-500 dark:text-orange-400">
            ...
            <div>
              ...
              <p>
                ...
                are not responsible for the quality, safety, or accuracy of the
                shared food.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                without your consent. For more details, visit our Privacy Policy
                page.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                PlateShare reserves the right to modify these Terms at any time.
                Updated terms will be effective immediately upon posting on the
                website.
              </p>
            </div>
          </section>
